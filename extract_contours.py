...
if __name__ == "__main__":
    folder_path = r"D:\Intern\datasets\exit_sign\robot_0602_correction_first"
    save_path = r"D:\Intern\datasets\exit_sign\robot_0602_correction_first_extracted"
    ...
    for file in file_list:
        ...
        contours = extract_contours(image.copy(), draw=False)
        cutouts = select_rect_upright(image, contours, draw=False)  # 正边界矩形筛选
        if not cutouts:
